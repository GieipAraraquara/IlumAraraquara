...
class ChamadosService {
    ...
    getMockChamados() {
        const mockRows = [
            { id: '1', protocolo: 'PC304KQ120826', data_abertura: '2026-08-07', data_conclusao: '2026-08-07T16:30:00Z', status: 'Concluída', prioridade: 'Normal', operador: 'Adriano', municipe_nome: 'Alexandre Medeiros', plaqueta_inicial: 'C0045', problema_inicial: 'Outro', qtd_inicial: 1, endereco: 'Praça Central de Araraquara', material_utilizado: 'Lâmpada LED 50W (x4), Reator 70W (x2)', historico_sessoes: [ { numero: 1, status: 'ENCERRADA', inicio: '2026-08-07T08:00:00Z', fim: '2026-08-07T10:30:00Z', duracao_minutos: 150, qtd_eletricistas: 2, tecnico: 'Adriano' }, { numero: 2, status: 'ENCERRADA', inicio: '2026-08-07T13:00:00Z', fim: '2026-08-07T15:00:00Z', duracao_minutos: 120, qtd_eletricistas: 2, tecnico: 'Adriano' } ] },
            { id: '2', protocolo: 'OS-2023-002', data_abertura: '2026-08-06', data_conclusao: '2026-08-06T11:00:00Z', status: 'Concluída', prioridade: 'Normal', operador: 'Ana', municipe_nome: 'Pma', plaqueta_inicial: 'F884', problema_inicial: 'Outro', qtd_inicial: 1, endereco: 'Rua das Flores, 123', material_utilizado: 'Fotocélula 100W, Cabo 10mm (x10)' },
            { id: '3', protocolo: 'IP1SBV0270726', data_abertura: '2026-08-10', status: 'Aberta', prioridade: 'Normal', operador: 'Igor', municipe_nome: 'Igor', plaqueta_inicial: 'C0011', problema_inicial: 'Lâmpada queimada', qtd_inicial: 1, endereco: 'C0011 - Av. Bento de Abreu' },
